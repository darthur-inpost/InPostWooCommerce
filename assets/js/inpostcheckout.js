...
///
// check_inpost_field_checked
//
function check_inpost_field_checked()
{
...
function add_inpost_fields()
{
	...
	var html = '';
  	...
  	html += '<table id="li_machine" border="0px">';
		       ...
		       html += '<img src="https://inpost247.uk/example-stores/images/map_icon.png" alt="InPost 24/7 Parcel Lockers" title="InPost 24/7 Parcel Lockers" </span></a>';
                    	html += '</div>';
                    	html += '</td>';
                    	html += '</tr>';
                    	html += '<tr>';
